...
def paginate(req, questions_data):
    ...
    questions_on_page = [Question.format(question)
...
def create_app(test_config=None):
    ...
    def get_categories():
        ...
        all_categories = {
            categorie.id: categorie.type for categorie in categories_data}
    ...
    the form will clear and the question will appear at end of the last page
    ...
    def add_new_question():
        ...
        if not (req_question and req_answer and
                req_difficulty and req_category):
    ...
    def quiz_question():
        ...
        try:
            ...
            #  if not set the questins value to None
            if questions_list:
